    ...
    public void onSensorChanged(SensorEvent event) {
        try {
            ...
            if (event.sensor.getType() == Sensor.TYPE_PROXIMITY) {
                ...
                //send 1 to arduino and arduino is coded to turn on/off the light on receiving 1
                msg = "1\n";
                ...
                if (gForce > max_gravity) {
                    ...
                    //send 2 to arduino and arduino is coded to turn on/off the fan on receiving 2
                    msg = "2\n";
                    outptStrm.write(msg.getBytes());
                }
